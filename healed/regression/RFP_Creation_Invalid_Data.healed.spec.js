//RFP_InvalidData.spec.js
import testData from '../../test-data.json';
const { test, expect } = require('../../fixtures/walker_fixture.js');
const { heal } = require('../../fixtures/inline_healer.js');
const { prepareSession } = require('../../helpers/sessionData');

test('RFP_Creation_Invalid_Data @regression @set1', async ({ page }) => {
  ...
  await heal(page, 'create rfp button', 'click', null,
    ...
    await expect(page.getByText('Required fields are missing. Please check the form.', { exact: true })).toBeVisible({
      timeout: 120000
    });
});
