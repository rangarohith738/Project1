...
test('Verify Estimate Button When User Assigned @regression @set1', async ({ page }) => {
  ...
  page.locator('button').filter({ hasText: 'Convert to Estimate' }).click();
  ...
  await expect(page.locator('//span[normalize-space()="Draft"]/preceding-sibling::div/span/span[normalize-space()="01"]')).toBeVisible;
